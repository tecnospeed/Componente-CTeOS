...
begin
  ...
  CTeOS.ConfigurarSoftwareHouse(edtSH.Text, edttoken.Text);
  CTeOS.LoadConfig('cteOSConfig.ini');
...
begin
  ...
  CTeOSDataSet.Campo('verProc_20').AsString := '4.00';
  ...
  aCRT_1573 := InputBox('Informe o código do regime tributário (CRT_1573)','1 – Simples Nacional ' +
  '2 – Simples Nacional(excesso sublimite de receita bruta) ' +
  '3 – Regime Normal','1');
  CTeOSDataSet.Campo('CRT_1573').AsString := aCRT_1573;
  ...
  CTeOSDataSet.Campo('versaoModal_147').AsString := '4.00';
