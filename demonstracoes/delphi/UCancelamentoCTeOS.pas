...
type
  TfrmCancelamentoCTeOS = class(TForm)
...
procedure TfrmCancelamentoCTeOS.btnOkClick(Sender: TObject);
begin
  ModalResult := mrNone;
...
procedure TfrmCancelamentoCTeOS.FormKeyPress(Sender: TObject; var Key: Char);
begin
  EnterAsTab_KeyPress(Self, Key, btnOk);
end;

procedure TfrmCancelamentoCTeOS.FormShow(Sender: TObject);
begin
  edtChave.SetFocus;
end;
