...
On Error GoTo TrataErroSH
    CTeOS.ConfigurarSoftwareHouse edtCNPJSH.Text, ""
TrataErroSH:
...
Private Sub ConfiguraCteOSDataSet()
    CTeOSDataSet.Versao = "3.00"
    CTeOSDataSet.ConfigSection = "XMLENVIO"
    CTeOSDataSet.MappingFileName = CTeOS.DiretorioEsquemas + "3.00\" + CTeOS.MappingFileName
...
End Function
        ...
        Private Sub VersaoModal()
            ...
            CTeOSDataSet.SetCampo "versao_3", "3.00"
            CTeOSDataSet.SetCampo "versao_1", "3.00"
